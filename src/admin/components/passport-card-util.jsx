...
export const FormularDocument = data => (
	<Document>
		<Page
			size={PageSizes.A4}
			style={{ ...passStyles.page, padding: mm2pt(20), paddingTop: mm2pt(10) }}
		>
			<Image
				src={logo}
				style={{
			...
			<Text style={formularStyles.text}>
				...
				„Spiel“ genannt) teilzunehmen und unterschreiben diese Einwilligung auf
				freiwilliger Basis. Wir, Unterzeichneten, erkennen an, und stimmen in
				unserem Namen dem Folgenden(in unserem eigenen Namen) zu:
			</Text>
			<Text style={formularStyles.text}>
				1. Bei der Buchung eines Spiels auf der Seite https://escapers.at selbst
				...
				Webadresse: https://escapers.at. Ich stimme den Regeln voll und ganz zu,
				habe keine Einwände, verstehe und akzeptiere die Regeln.
			</Text>
			<Text style={formularStyles.text}>
				2. Vor der Buchung einer Sitzung habe ich die auf der Website
				präsentierte Nutzungsvereinbarung gelesen und akzeptiert, die sich unter
				der Webadresse der Internetressource befindet: https://escapers.at. Ich
				akzeptiere die Vereinbarung zum öffentlichen Angebot
			</Text>
			<Text style={formularStyles.text}>
				...
				persönlichen Disziplin diese Risiken verringern kann, bleibt das Risiko
				schwerer Verletzungen bestehen. Mir ist bewusst, dass es sich bei den
				Unterhaltungsangeboten der Internetressource: Escapers GmbH um Spiele
				handelt, die zu Verletzungen führen können
			</Text>
			<Text style={formularStyles.text}>
				4. Ich übernehme wissentlich und freiwillig die Verantwortung für diese
				...
				anderer Personen ergeben, übernehme ich die volle Verantwortung für
				meine Teilnahme an der Games Escapers GmbH. Sollte ich jedoch während
				meiner Anwesenheit oder Teilnahme an den Spielen eine nicht übliche oder
				erhebliche Gefahr für Leben oder Körperverletzung feststellen,
				verpflichte ich mich, meine Teilnahme am Spiel einzustellen und den
				Veranstalter und Ausführenden des Ereignisses einer solchen Bedrohung
				unverzüglich mündlich zu unterrichten, oder per Telefonverbindung.
			</Text>
			<Text style={formularStyles.text}>
			...
			<Text style={formularStyles.text}>
				...
				Veranstalter der Spiel Escapers GmbH, Administratoren, andere Darsteller
			...
			<Text style={formularStyles.text}>
				...
				Scherenschnittbilder und andere Materialien, die die Reproduktion meines
				Aussehens und meiner Stimme beinhalten, für Marketingzwecke als Teil der
				Werbung, um das Ziel anzusprechen Publikum, sowie zur Vorlage an
				Strafverfolgungsbehörden im Falle eines Verstoßes gegen österreichisches
				Recht.
			</Text>
			<Text style={formularStyles.text}>
				...
				Krankheiten, die eine Verschlechterung der Gesundheit verursachen und zu
				Komplikationen der Krankheit oder sogar zum Tod führen können, nicht
				spielen dürfen. Durch diese Vereinbarung bestätige ich, dass ich NICHT
				an den oben genannten Krankheiten und anderen Krankheiten leide, die
				während/nach dem Spiel gesundheitliche Komplikationen verursachen oder
		...
		>
			...
			<Text style={formularStyles.text}>
				...
				verursachten Schaden. Es ist mir klar, dass ich in meinem eigenen Namen
				alle Risiken und Verantwortlichkeiten übernehme, wenn ich diese
				Dienstleistungen erbringe.
			</Text>
			<Text style={formularStyles.text}>
				11. Ich verstehe und akzeptiere die folgenden Einschränkungen für die
				Teilnahme an Virtual-Reality-Spielen: Wir bitten Sie, besonders auf die
				folgenden Einschränkungen zu achten! Die Teilnahme an Spielen in der
				virtuellen Realität wird Menschen mit epileptischen Anfällen und anderen
				Anfällen nicht empfohlen. Das Mindestalter für die Teilnahme an Spielen
				beträgt 13 Jahre (in Anwesenheit der Eltern). Einige Spiele enthalten
				beängstigende Szenen und Klänge und können Altersbeschränkungen haben.
				Eltern sind verpflichtet, das Wohlbefinden ihrer Kinder während des
				Spiels zu überwachen und das Spiel zu stoppen, wenn sich der Zustand des
				Kindes verschlechtert. Einige Spielelemente beinhalten farbliche
				Unterscheidungen, daher können Menschen mit Farbenblindheit erhebliche
				Schwierigkeiten beim Spielen haben. Der in dem Spiel verwendete Ton ist
				auf 93 Dezibel begrenzt. Wenn Sie während des Spiels Unbehagen aufgrund
				von Geräuschen oder anderer Umstände verspüren, sind Sie verpflichtet,
				dies dem Betreiber sofort mitzuteilen.
			</Text>
			<Text style={formularStyles.text}>
			...
			<Text style={formularStyles.text}>
				Escapers GmbH als Ganzes sowie deren leitenden Angestellten, Vertretern
				und/oder Mitarbeitern, anderen Mitgliedern, Geldgebern, Sponsoren,
				Werbetreibenden und gegebenenfalls den Eigentümern und Vermietern der
